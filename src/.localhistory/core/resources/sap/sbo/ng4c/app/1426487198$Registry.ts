...
module sap.sbo.ng4c.app {
    ...
    export class Registry {
        ...
        private static _constant: IConstant[] = [];

        public static get constant(): IConstant[] {
            if (Registry._constant.length > 0) return Registry._constant;
            var services: IConstant[] = Registry._services;
