...
module sap.sbo.ng4c.app {
    ...
    export class Registry {
        ...
        public static get controls(): IControl[] {
            ...
            collection.push({ name: "ng4c-tree", directive: sap.sbo.ui.controls.TreeDirective });
            collection.push({ name: "ng4c-button", directive: sap.sbo.ui.controls.ButtonDirective });
            collection.push({ name: "ng4c-datePicker", directive: sap.sbo.ui.controls.DatePickerDirective });
            ...
            collection.push({ name: "ng4c-label", directive: sap.sbo.ui.controls.LabelDirective });
