...
module sap.sbo.ng4c.app {
    ...
    export class Registry {
        ...
        public static get controls(): IControl[] {
            ...
            collection.push({ name: "sap.sbo.ui.controls.Button", directive: sap.sbo.ui.controls.ButtonDirective });
            collection.push({ name: "sap.sbo.ui.controls.DatePicker", directive: sap.sbo.ui.controls.DatePicker });
            collection.push({ name: "sap.sbo.ui.controls.DecimalInput", directive: sap.sbo.ui.controls.DecimalInput });
            collection.push({ name: "sap.sbo.ui.controls.Input", directive: sap.sbo.ui.controls.Input });
            collection.push({ name: "sap.sbo.ui.controls.Label", directive: sap.sbo.ui.controls.Label });
            collection.push({ name: "sap.sbo.ui.controls.LinkedInput", directive: sap.sbo.ui.controls.LinkedInput });
            collection.push({ name: "sap.sbo.ui.controls.NumberInput", directive: sap.sbo.ui.controls.NumberInput });
            collection.push({ name: "sap.sbo.ui.controls.Select", directive: sap.sbo.ui.controls.Select });
            collection.push({ name: "sap.sbo.ui.controls.TextArea", directive: sap.sbo.ui.controls.TextArea });
