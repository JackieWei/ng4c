...
module sap.sbo.ng4c.app {
    ...
    export class Registry {
        ...
        public static get constants(): IConstant[] {
            ...
            var constants: IConstant[] = Registry._services;

            /* Registry begins */
            //never name a service or any directive like route/router
            //It will cause angular confuse and everything will be a mess.
            constants.push({ name: "storage", service: sap.sbo.ng4c.app.Storage });
            constants.push({ name: "router", service: sap.sbo.ng4c.app.Router });
            constants.push({ name: "backend", service: sap.sbo.ng4c.app.Backend });
