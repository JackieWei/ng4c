...
module sap.sbo.ng4c.app {
    ...
    export class Registry {
        ...
        public static get servies(): IService[] {
            ...
            //It will cause angular confusion 
            services.push({ name: "storageSevice", service: sap.sbo.ng4c.app.Storage });
            services.push({ name: "routerService", service: sap.sbo.ng4c.app.Router });
            services.push({ name: "backendService", service: sap.sbo.ng4c.app.Backend });
